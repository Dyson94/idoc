...
while ($db_field = mysql_fetch_assoc($result)) {
	...
	echo("<tr>");
	if($a == 0){
		echo("<td align = 'center' width = '1'><a href = 'read_mail.php?key=".$ctrl."'><img src = 'images/unopened.jpg' border = '0'></img></a></td>");
	}
	else{
	...
	echo("<td align = 'center' width ='75'><a href = 'reply_mail.php?key=".$b."'><img src = 'images/reply.jpg' border = '0'></img></a>");
	echo("<a href = 'delete_mail.php?key=".$ctrl."'><img src = 'images/deletemail.jpg' border = '0'></img></a></td>");
	echo("</tr>");
}
?>
